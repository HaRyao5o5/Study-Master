...
import { X, Sparkles, Loader, AlertCircle, Image as ImageIcon, Trash2, FileText, Upload, Lock, ArrowRight } from 'lucide-react';
        ...
        <div className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          {!canUseAI ? (
            <div className="py-8 flex flex-col items-center text-center animate-fade-in">
              <div className="mb-6 p-6 bg-gradient-to-br from-purple-500 to-pink-500 text-white rounded-[2.5rem] shadow-2xl ring-8 ring-purple-50 dark:ring-purple-900/20 transform rotate-3">
                <Lock size={48} />
              </div>
              <h4 className="text-2xl font-black text-gray-800 dark:text-white mb-3">AI 生成は PRO 限定です</h4>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-bold mb-8 max-w-sm leading-relaxed">
                テキストや画像から自動でクイズを作成する機能は PRO プラン専用です。<br/>
                学習の手間を 90% 削減しましょう。
              </p>
              ...
              <div className="space-y-3 w-full max-w-xs mb-8">
                <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 text-left">
                  ...
                  <span className="text-xs font-bold text-gray-700 dark:text-gray-300">画像からクイズを一瞬で作成</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 text-left">
                  <div className="p-2 bg-pink-100 dark:bg-pink-900/30 text-pink-600 dark:text-pink-400 rounded-lg">
                    <FileText size={16} />
                  </div>
                  <span className="text-xs font-bold text-gray-700 dark:text-gray-300">長い文章を読解して問題化</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full max-w-xs py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-black rounded-2xl shadow-xl shadow-purple-500/20 hover:shadow-purple-500/40 hover:-translate-y-1 transition-all flex items-center justify-center gap-2 group"
              >
                PRO プランを確認
