// src/components/course/CreateCourseModal.tsx
import React, { useState, useEffect } from 'react';
import { X, Save, Lock, Globe, Link as LinkIcon, FolderPlus, LucideIcon } from 'lucide-react';

interface CreateCourseModalProps {
  onClose: () => void;
  onSave: (title: string, description: string, visibility: string) => void;
  initialData?: {
    title: string;
    description: string;
    visibility: string;
...
const CreateCourseModal: React.FC<CreateCourseModalProps> = ({ onClose, onSave, initialData = null }) => {
