// src/components/editor/InputAnswersEditor.jsx
 ...
 * 記述式問題の正解編集コンポーネント
 * @param {Object} props
 * @param {string[]} props.answers - 正解リスト
 * @param {Function} props.onChange - 正解変更コールバック
 * @param {Function} props.onAdd - 正解追加コールバック
 * @param {Function} props.onRemove - 正解削除コールバック
 */
export function InputAnswersEditor({ answers, onChange, onAdd, onRemove }) {
  return (
    <div>
