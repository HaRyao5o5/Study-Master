...
const GoalProgress: React.FC<GoalProgressProps> = ({ goals, onClick }) => {
  ...
  return (
    <div 
      onClick={onClick}
      className={`bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 mb-6 border border-blue-200 dark:border-gray-600 ${onClick ? 'cursor-pointer hover:shadow-md transition-shadow' : ''}`}
    >
