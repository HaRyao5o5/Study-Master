// src/components/common/GoalSettingsModal.jsx
import React, { useState } from 'react';
import { X, Target, TrendingUp } from 'lucide-react';

const GoalSettingsModal = ({ goals, onSave, onClose }) => {
  const [dailyGoal, setDailyGoal] = useState(goals.dailyXpGoal);
  const [weeklyGoal, setWeeklyGoal] = useState(goals.weeklyXpGoal);
