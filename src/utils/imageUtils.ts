 ...
 */
export const resizeImage = (file: File, maxWidth = 800, maxHeight = 600): Promise<string> => {
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (e) => {
      ...
      if (e.target?.result) {
        ...
        reject(new Error('ファイル読み込み結果が空です'));
      }
    };
...
export const getBase64Size = (base64String: string): number => {
  ...
  // data URL prefix removal might be needed for exact calc, but logic here follows original
